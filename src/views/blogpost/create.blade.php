...
<head>
    ...
    <body>
      ...
      <form action="{{route('allblogpost')}}" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="form-group">
            ...
            {{$item->category_name}} <input type="checkbox" name="category[]" value="{{$item->id}}"><br>
            @endforeach
          </div>

          <div class="form-group">
            <label for="exampleFormControlTextarea1">Meta title</label>
            <input type="text" class="form-control" name="metatitle" id="exampleFormControlInput" placeholder="Meta Title">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="metatags" id="exampleFormControlInput" placeholder="Meta Tags">
          </div>
